    ...
    <div className="flex background-white  h-screen overflow-hidden">
      ...
      <div className="flex-1 p-24   overflow-auto">
        <div className="bg-white p-16 rounded-lg">
          ...
          <p className="font-normal mt-4 text-gray-400">PERSONAL INFO</p>
<div className="flex flex-col gap-4 w-full my-6">
  ...
  <div className="flex gap-4">
    <div className="flex flex-col gap-1 flex-1">
      <label className="text-sm font-medium text-gray-700">Field 3</label>
      <input
        type="text"
    ...
    <div className="flex flex-col gap-1 flex-1">
      <label className="text-sm font-medium text-gray-700">Field 4</label>
      <input
        type="text"
